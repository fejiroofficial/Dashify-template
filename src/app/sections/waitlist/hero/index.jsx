  ...
  return (
    <section className="hero container mx-auto relative flex flex-col items-center justify-center text-center w-full lg:mb-8 px-4 pb-8">
      <div className="relative z-10">
        ...
        <p className="mb-8 flex-wrap px-6 lg:px-0 pb-6">
          Seamless integration with <br />
          Gmail, GitHub, Google Calendar, Trello and lots more.
        </p>
        <div className="relative  flex flex-col items-center bg-white text-black-BASE gap-8 rounded-lg mt-10 h-[416px] overflow-hidden">
          ...
          <div className="flex flex-col gap-2 pb-6 justify-end items-end">
            ...
            />
            <button className="bg-black-BASE text-white w-full md:w-[408px] md:h-[63px] rounded-lg text">
              Sign up for Waitlist <br />{" "}
              <span className="small">Free ebook inclusive</span>{" "}
            </button>
          </div>
        </div>
