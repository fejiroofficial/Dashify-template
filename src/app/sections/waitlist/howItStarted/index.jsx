  ...
  return (
    <div className='container mx-auto flex flex-col justify-center items-center px-6 h-screen '>
        ...
        <div className='flex flex-col gap-6 flex-1'>
            <p className='sub-header'>In this section, you are going to share how you came across the idea or problem, acknowledging the problem, showing empathy and why you felt led to create this solution.</p>
            <p className='sub-header'>In this section, you are going to share how you came across the idea or problem, acknowledging the problem, showing empathy and why you felt led to create this solution.</p>
            <p className='sub-header'>In this section, you are going to share how you came across the idea or problem, acknowledging the problem, showing empathy and why you felt led to create this solution.</p>
        </div>
