...
const Problem = () => {
  return (
    <section className="lg:container mx-auto flex flex-col lg:items-center text-center lg:pt-28 lg:px-2 font-[Figtree]">
      <div className="mb-8 flex flex-col justify-center text-center mt-6 px-4 lg:mt-8">
        <h2 className="text-[32px] md:text-[48px] font-bold mb-4">
          Stop spending hours gathering data 🤕
        </h2>


        <p className="text-[18px] lg:text-xl text-gray-300 max-w-[679.46px] text-center px-2 pb-6 lg:pb-0">
      ...
      <div className="flex flex-col lg:flex-row md:items-center lg:justify-center gap-12 lg:py-16 w-full max-w-5xl px-4">
        ...
        <div className="flex flex-col gap-6 px-2 lg:px-4">
