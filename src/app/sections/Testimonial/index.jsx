...
const Testimonial = ({ rating = 5, name }) => {
  return (
    <div className="container mx-auto relative bg-[#0E0E0E] flex flex-col items-center text-center py-6 px-6 lg:px-16 rounded-2xl gap-4 overflow-hidden mb-10 w-[95%] lg:w-[54%] border-solid max-w-5xl">
